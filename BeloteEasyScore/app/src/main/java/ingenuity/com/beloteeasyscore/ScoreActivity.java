...
public class ScoreActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new DownloadImage((ImageView) findViewById(R.id.player1Team1Picture)).execute(getUserPictureUrl());

        TextView player2Team1 = (TextView)findViewById(R.id.player2Team1);
        player2Team1.setText(""+getUserName()+" "+getUserSurname());
        new DownloadImage((ImageView) findViewById(R.id.player2Team1Picture)).execute(getUserPictureUrl());

        TextView player1Team2 = (TextView)findViewById(R.id.player1Team2);
        player1Team2.setText(""+getUserName()+" "+getUserSurname());
        new DownloadImage((ImageView) findViewById(R.id.player1Team2Picture)).execute(getUserPictureUrl());

        TextView player2Team2 = (TextView)findViewById(R.id.player2Team2);
        player2Team2.setText(""+getUserName()+" "+getUserSurname());
        new DownloadImage((ImageView) findViewById(R.id.player2Team2Picture)).execute(getUserPictureUrl());
